...
final class ProcessDetailsTests: XCTestCase {
	...
	func testTimeSinceProcessStart() {
		...
		XCTAssertGreaterThan(time, Duration.seconds(0))
		XCTAssertLessThan(time, Duration.seconds(300)) // should take less than 5 minutes, unless Symantec DLP gets involved
	}
}
